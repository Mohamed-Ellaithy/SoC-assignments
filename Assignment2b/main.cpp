...
////	y = B.read();
//
//	FA8bits FA_8bits("FA_8bits");
//	FA_8bits.A(A);
//	FA_8bits.B(B);
//	FA_8bits.Total_Sum(Total_Sum);
//
//	sc_start(500,SC_NS);
//
//	cout << "Total sum = " << Total_Sum.read().to_int() << endl;
//	return 0;
//}
#include "systemc.h"
#include "FA.h"
...
int sc_main(int argc, char* argv []){
	...
	cout << "\nA   :    " << A.read() << "\t(" << A.read().to_int() << ")" << endl;
	cout << "B   :  + " << B.read() << "\t(" << B.read().to_int() << ")" << endl;
	cout << "        ---------" <<endl;
	cout << "Sum :   " << Total_Sum.read() << "\t(" << Total_Sum.read().to_int() << ")\n" << endl;
	return 0;
}
