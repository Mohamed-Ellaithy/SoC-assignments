# ==============================================================
# File generated on Sat Feb 22 23:17:30 EET 2020
...
$(ObjDir)/FA.o: ../../../FA.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../FA.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \
