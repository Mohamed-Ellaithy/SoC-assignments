# ==============================================================
# File generated on Wed Feb 19 00:01:18 EET 2020
...
HLS_SOURCES = ../../../MatMult_tb.cpp ../../../MatMult.cpp
...
$(ObjDir)/MatMult_tb.o: ../../../MatMult_tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../MatMult_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/MatMult_tb.d
